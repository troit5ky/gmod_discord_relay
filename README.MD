...
3. Finally, edit `gmod_discord_relay/lua/cl_config.lua` and `gmod_discord_relay/lua/sv_config.lua` to configure the addon. 
...
## Preview
![discordpreview](preview/1.png)
![gmodpreview](preview/2.png)
